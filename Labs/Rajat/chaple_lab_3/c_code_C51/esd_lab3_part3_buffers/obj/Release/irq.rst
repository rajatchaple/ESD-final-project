      ...
      002093 30 98 0A         [24]  301 	jnb	_RI,00104$
                                    302 ;	irq.c:24: received_char = SBUF;
      002096 90 13 8D         [24]  303 	mov	dptr,#_received_char
      002099 E5 99            [12]  304 	mov	a,_SBUF
      00209B F0               [24]  305 	movx	@dptr,a
                                    306 ;	irq.c:25: RI = 0;
                                    307 ;	assignBit
      00209C C2 98            [12]  308 	clr	_RI
      00209E 80 05            [24]  309 	sjmp	00105$
      0020A0                        310 00104$:
                                    311 ;	irq.c:27: else if (TI == 1) // character transmitted
                                    312 ;	irq.c:29: TI = 0;
                                    313 ;	assignBit
      0020A0 10 99 02         [24]  314 	jbc	_TI,00117$
      0020A3 80 00            [24]  315 	sjmp	00105$
      0020A5                        316 00117$:
      0020A5                        317 00105$:
                                    318 ;	irq.c:32: P1_1 = !P1_1; // Show the data has been updated
      0020A5 B2 91            [12]  319 	cpl	_P1_1
                                    320 ;	irq.c:33: }
      0020A7 22               [24]  321 	ret
                                    322 	.area CSEG    (CODE)
                                    323 	.area CONST   (CODE)
                                    324 	.area XINIT   (CODE)
