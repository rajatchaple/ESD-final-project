...
;	main.c:60: putstr("\r\n----------------------------------------------------------------------\r\n\r\n");
	...
	mov	b,#0x80
	lcall	_putstr
;	main.c:61: putstr("Enter command: ");
	mov	dptr,#___str_2
	mov	b,#0x80
	lcall	_putstr
;	main.c:63: while (1)
00102$:
;	main.c:66: received_char = getchar();
	lcall	_getchar
	mov	r6,dpl
;	main.c:67: DEBUGPORT(received_char);
	...
	lcall	_dataout
	pop	ar6
;	main.c:69: echo(received_char); // echoing characters back
	mov	dpl,r6
	push	ar6
	lcall	_echo
	pop	ar6
;	main.c:71: command(received_char);
	mov	dpl,r6
	lcall	_command
;	main.c:73: }
	sjmp	00102$
...
___str_1:
	...
	.db 0x0d
	.db 0x0a
	.ascii "3. Set FCLK PERIPH at the minimum frequency"
	.db 0x0d
	.db 0x0a
	.ascii "4. Set FCLK PERIPH at the maximum frequency"
	.db 0x0d
	.db 0x0a
