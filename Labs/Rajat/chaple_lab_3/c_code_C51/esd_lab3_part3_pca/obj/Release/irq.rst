      ...
      000000                        218 	.ds 8
                                    ...
                                    280 	.area CSEG    (CODE)
                                    281 ;------------------------------------------------------------
                                    282 ;Allocation info for local variables in function 'EXT_INT0_ISR'
                                    283 ;------------------------------------------------------------
                                    284 ;	irq.c:17: void EXT_INT0_ISR (void) __interrupt 0
                                    285 ;	-----------------------------------------
                                    286 ;	 function EXT_INT0_ISR
                                    287 ;	-----------------------------------------
      002093                        288 _EXT_INT0_ISR:
                           000007   289 	ar7 = 0x07
                           000006   290 	ar6 = 0x06
                           000005   291 	ar5 = 0x05
                           000004   292 	ar4 = 0x04
                           ...
                           000001   295 	ar1 = 0x01
                           000000   296 	ar0 = 0x00
                                    297 ;	irq.c:19: PCON &= ~0x01;
      002093 53 87 FE         [24]  298 	anl	_PCON,#0xfe
                                    299 ;	irq.c:20: }
      002096 32               [24]  300 	reti
                                    301 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    302 ;	eliminated unneeded push/pop psw
                                    303 ;	eliminated unneeded push/pop dpl
                                    304 ;	eliminated unneeded push/pop dph
                                    305 ;	eliminated unneeded push/pop b
                                    306 ;	eliminated unneeded push/pop acc
                                    307 	.area CSEG    (CODE)
                                    308 	.area CONST   (CODE)
                                    309 	.area XINIT   (CODE)
